...
/**
 * Generic content container. Purely presentational — links, headings and
 * actions are composed by the caller instead of being hard-coded here.
 */
...
export const CardTitle = React.forwardRef<HTMLHeadingElement, React.HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3 ref={ref} className={cn("text-lg font-semibold leading-heading", className)} {...props} />
  ),
);
